...
def _decide_reply(messages: list) -> str:
    ...
    if "script doctor proposing a targeted revision" in system_l:
        ...
        # target a line the manuscript actually RENDERS: the scene heading
        # follows the [Scene n — ...] header and is real in the elements
        # list, but renderScenePage draws headings from heading_raw and
